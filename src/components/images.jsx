...
import { caretBackSharp,caretForwardSharp, closeCircle, earthSharp} from 'ionicons/icons';
...
const ImageView_ = (props) =>{
    // console.log(props)
    return(
    <div style={{display:'inline-block',marginLeft:'10px',maxHeight:'50rem'}}>
        <IonCard>
            <IonItem>
                <IonButton 
        ...
        <div>
        {
            ...
            <div style={{display:'inline-block',marginLeft:'10px',maxHeight:'50rem'}}>
                <IonCard>
                    <IonItem>
                        <IonIcon  
                            color="secondary" slot="start" size="large" 
                            icon={caretBackSharp} 
                        ...
                        <IonIcon  
                            color="primary" slot="start" size="large" 
                        ...
                        <a style={{marginLeft:'2rem',border:'none'}} href={props.mapillary} target="_blank">
                        <IonIcon  
                            href={props.mapillary} target="_blank" color="primary" 
                            slot="end" size="large" icon={earthSharp}/>
                        </a>
                        {/* </button> */}
                            {/* </IonIcon> */}
                        ...
                        <IonIcon  color="danger" slot="end" size="large" icon={closeCircle} onClick={()=>props.onSetShow(false)}></IonIcon>
                ...
                return (
                  <div style = {{padding:'1rem'}}>
                    ...
                    <img 
                          ...
                          borderRadius: imgurl.properties.url === props.urlsel ? 10:1,
                          transform: imgurl.properties.url === props.urlsel ? 'scale(1.0)':null }}
                      />
                  </div>
                )
...
const LoadMore = (props) => {
    ...
    return (
        <div>
            ...
            props.show ?
            // return (
                <div style={{marginLeft:'2rem', marginRight:'2rem',marginBottom: '2rem'}} className="load-more">
                    <button 
                    onClick={() => {props.onUpdate(props.update+5)}}
                    className="btn-grad">
                    Load More
                    </button>
                </div>
